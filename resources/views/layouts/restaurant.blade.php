            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="#" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            {{-- <img src="{{asset("assets/admin/images/logo.jpg")}}" alt="" style="width: 200px; height: 90px;"> --}}
                        </span>
                    </a>
                </div>
                ...
                <div class="d-none d-sm-block ml-2">
                    ...
                    <h4 class="page-title">{{ Auth::guard('restaurant')->user()->name_ar}}</h4>
                    @endif
                </div> 
            </div>
