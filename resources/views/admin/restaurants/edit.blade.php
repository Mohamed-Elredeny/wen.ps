    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-5 mt-3">تعديل المطعم </h5>
                ...
                <form method="post" action="{{route('admin.restaurants.update',['restaurant'=>$restaurant->id])}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" name="name_ar" value="{{$restaurant->name_ar}}" required>
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" name="name_en" value="{{$restaurant->name_en}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$restaurant->email}}" name="email" type="email" id="example-text-input">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$restaurant->phone}}" name="phone" type="number" id="example-text-input">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="package_id" required>
                                    ...
                                    <option {{ ($package->id) == $restaurant->package_id ? 'selected' : '' }} value="{{$package->id}}">{{$package->name_ar}}</option>
                                    @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="status" required>
                                    ...
                                    <option {{ $restaurant->status == 1 ? 'selected' : '' }} value="1">نشط</option>
                                    <option {{ $restaurant->status == 0 ? 'selected' : '' }} value="0">غير نشط</option>
