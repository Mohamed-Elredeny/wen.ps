    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-5 mt-3">اضافة باقة جديد</h5>
                ...
                <form method="post" action="{{route('admin.packages.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" name="duration" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea id="elm1" class="elm1" name="details_ar">اكتب هنا .. </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea id="elm1" class="elm1" name="details_en">اكتب هنا .. </textarea>
                        </div>
                    </div>
