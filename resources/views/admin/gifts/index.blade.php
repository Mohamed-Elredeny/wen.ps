            ...
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <th>
                            <center>
                                <a class="btn btn-dark col-sm-12" onclick="modelDes('{{$gift->id}}','{!! $gift->details_ar !!}')" data-toggle="modal" data-target="#images{{$gift->id}}">التفاصيل</a><br>
                            </center>
                        </th>
                        <th>
                            <center>
                                <a class="btn btn-dark col-sm-12" onclick="modelDes('{{$gift->id}}','{!! $gift->details_en !!}')" data-toggle="modal" data-target="#images{{$gift->id}}">التفاصيل</a><br>
                            </center>
                        </th>

                        <th>
                            <center>
                                <a class="btn btn-dark col-sm-12" onclick="modelImage('{{$gift->id}}','{{$gift->image}}')" data-toggle="modal" data-target="#file{{$gift->id}}">الصور</a><br>
                            </center>
                        </th>
                                ...
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            {{-- <a class="btn btn-dark col-sm-12"  href="{{route('admin.gifts.show',['gift'=>$gift->id])}}">عرض</a><br> --}}
                                            <a class="btn btn-dark col-sm-12"  href="{{route('admin.gifts.edit',['gift'=>$gift->id])}}">تعديل</a>
                                            <form method="post" action="{{route('admin.gifts.destroy',['gift'=>$gift->id])}}">
                                                @csrf
                                                @method('DELETE')
