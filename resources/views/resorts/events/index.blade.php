        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <thead>
                    <tr>
                        <th>الحفلة بالعربية</th>
                        <th>الحفلة بالانجليزية</th>
                        <th>الصورة</th>
                        <th>التحكم</th>
                    </tr>
                    </thead>
                                ...
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <a class="btn btn-dark col-sm-12"  href="{{route('resort.events.show',['event'=>$event->id])}}">عرض</a><br>
                                            <a class="btn btn-dark col-sm-12"  href="{{route('resort.events.edit',['event'=>$event->id])}}">تعديل</a>
                                            <form method="post" action="{{route('resort.events.destroy',['event'=>$event->id])}}">
                                                @csrf
                                                @method('DELETE')
