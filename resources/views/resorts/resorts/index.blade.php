            ...
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <th>{{$resort->name_ar}}</th> 
                        <th>{{$resort->name_en}}</th> 
                        <th>{{$resort->resort->name_ar}}</th> 
                        <th>{{$resort->price}}</th> 
                        <th>
                            <center>
                                <a class="btn btn-dark col-sm-12" onclick="modelDes('{{$resort->id}}','{{$resort->details_ar}}')" data-toggle="modal" data-target="#des{{$resort->id}}">التفاصيل</a><br>
                            </center>
                        </th> 
                        <th>
                            <center>
                                <a class="btn btn-dark col-sm-12" onclick="modelDes('{{$resort->id}}','{{$resort->details_en}}')" data-toggle="modal" data-target="#des{{$resort->id}}">التفاصيل</a><br>
                            </center>
                        </th> 
