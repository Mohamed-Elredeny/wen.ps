            ...
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <th>
                            <center>
                                <a class="btn btn-dark col-sm-12" href="{{route('resort.categories.resorts',$category->id)}}">المنتجعات</a><br>
                            </center>
                        </th>
                        <th>
                            <center>
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="btn btn-dark col-sm-12"  href="{{route('resort.categories.edit',['category'=>$category->id])}}">تعديل</a>
                                            <form method="post" action="{{route('resort.categories.destroy',['category'=>$category->id])}}">
                                                @csrf
                                                @method('DELETE')
