                                ...
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <a class="btn btn-dark col-sm-12"  href="{{route('hotel.services.edit',['service'=>$service->id])}}">تعديل</a>
                                            <form method="post" action="{{route('hotel.services.destroy',['service'=>$service->id])}}">
                                                @csrf
                                                @method('DELETE')
