                ...
                <div class="inner">
                    ...
                    @if(LaravelLocalization::getCurrentLocale() == 'ar')
                        <div class="col-md-12 col-sm-12">
                            <h1>{{$package->name_ar}}</h1>
                            <ol class="breadcrumb">
                                <li><a href="{{route('home.index')}}">{{__('site.home')}}</a></li>
                                <li>{{$package->name_ar}}</li>
                            </ol>
                        </div>
                    @else
                    
                        <div class="col-md-12 col-sm-12">
                            <h1>{{$package->name_en}}</h1>
                            <ol class="breadcrumb">
                                <li><a href="{{route('home.index')}}">{{__('site.home')}}</a></li>
                                <li>{{$package->name_en}}</li>
                            </ol>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                            ...
                            <div id="slider-larg" class="owl-carousel image-gallery">
                                ...
                                <div class="item lightbox-image-icon">
                                    <p
                                        ...
                                        <img class="img-responsive" src="{{asset('/')}}{{$package->image}}"
                                            alt="Image">
                                    </p>
                                </div>
                        ...
                        <div class="main_title mt50">
                            <h2>{{__('site.about_package')}}</h2>
                        </div>
    
                       @if(LaravelLocalization::getCurrentLocale() == 'ar')
                        <p class="text-center">{!! $package->details_ar !!}</p>
                        @else
                        <p class="text-center">{!! $package->details_en !!}</p>
                        @endif
