                        ...
                        <div class="slider">
                            <div id="slider-larg" class="owl-carousel image-gallery">
                                ...
                                <div class="item lightbox-image-icon">
                                    ...
                                    <img src="{{asset('/')}}{{$event->image}}" class="img-responsive" alt="Image"></a>
                                    </figure>
                                    ...
                                    <div class="col-md-4" style="margin-bottom: 25px;">
                                        <article class="room">
                                            <figure>
                                                ...
                                                <figcaption>
                                                    <h4><a href="{{route('resort.event_details',$event->id)}}">
