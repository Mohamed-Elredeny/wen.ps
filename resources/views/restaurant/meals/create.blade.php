    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-5 mt-3">اضافة وجبة جديد</h5>

                <form method="post" action="{{route('restaurant.meals.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" name="component_ar" required>
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" name="component_en" required>
                        </div>
                    </div> 
        ...
        $.ajax({
           ...
           {     
                ...
                if(res.length > 0){
                        ...
                        $('#size').append("<div class='row m-2'><div class='col-sm-6'><div class='row'><div class='col-sm-12'><input class='form-control' type='number' id='example-text-input' name='price[]' required></div></div></div></div>");
                }
           }
