    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-5 mt-3">اضافة طاولة جديد</h5>

                <form method="post" action="{{route('restaurant.tables.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">رقم الطاولة</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="number" id="example-text-input" name="table_id" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">عدد الأفراد</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="number" id="example-text-input" name="people_number" required>
                        </div>
                    </div> 
