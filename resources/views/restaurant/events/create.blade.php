    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-5 mt-3">اضافة حفلة جديد</h5>

                <form method="post" action="{{route('restaurant.events.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea id="elm1" class="elm1" name="description_en">اكتب هنا .. </textarea>
                        </div>
                    </div>
