                                ...
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <a class="btn btn-dark col-sm-12"  href="{{route('restaurant.events.show',['event'=>$event->id])}}">عرض</a><br>
                                            <a class="btn btn-dark col-sm-12"  href="{{route('restaurant.events.edit',['event'=>$event->id])}}">تعديل</a>
                                            <form method="post" action="{{route('restaurant.events.destroy',['event'=>$event->id])}}">
                                                @csrf
                                                @method('DELETE')
