            ...
            -->
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <th>{{$meal->meal->name_ar}}</th> 
                        <th>{{ \App\models\Book_meals::where('restaurant_id',$meal->restaurant_id)->sum('qty') }}</th> 
                        <th>{{ \App\models\Book_meals::where('restaurant_id',$meal->restaurant_id)->sum('money') }}</th>
                        </tr>
                        @endforeach
